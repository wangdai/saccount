...
<div class="container">
	...
	<!-- <div class="row"> -->
		<div class="span4"><h1>股票交易系统</h1></div>
  </div>
	  	...
	  	<form class="form-horizontal" action="<?php echo U('create');?>" method="post">
	  		<fieldset>
	  			...
	  			<div class="form-group"  id="id_no" >
	  				...
	  				<div class="controls">
	  					<input class="form-control input-lg" name="id_no" id="personid" type="text" placeholder="身份证号码">
	  				</div>
	  			</div>
	  		</fieldset>		
...
<script type="text/javascript">
	...
	$("#name").focusout(function(){denyemptyinput("#name")});
	$("#id_no").focusout(function(){if(!denyemptyinput("#id_no")) validateid("#id_no")});
	$("form").submit(function(e){

		if(denyemptyinput("#name"))
			e.preventDefault();
		if(denyemptyinput("#id_no"))
			e.preventDefault();
		else if(validateid("#id_no"))
			e.preventDefault();
	}		
	);
