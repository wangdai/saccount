	...
	<ul class="nav nav-tabs">
		...
		<fieldset>
			...
			<div name="huge" class="select-block mbl">
		  	...
		  	<form method="get" action="<?php echo U('result');?>"  class="form-horizontal"  id="form-0">
			...
			<form method="get" action="<?php echo U('result');?>"  class="form-horizontal"  id="form-1" hidden>
