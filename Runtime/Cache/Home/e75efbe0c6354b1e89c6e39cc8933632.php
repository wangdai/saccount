...
<div class="container">
	...
	$("#repid").focusout(function(){if(!denyemptyinput("#repid"))validateid("#repid");});
	...
	$("#authorpid").focusout(function(){if(!denyemptyinput("#authorpid"))validateid("#authorpid");});
